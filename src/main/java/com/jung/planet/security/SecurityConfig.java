...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                // 인증 요구 사항 설정
                .authorizeHttpRequests(auth -> auth.requestMatchers("/plants/add/{id:[\\d]+}", "/plants/my", "/plants/edit/{id:[\\d]+}", "/plants/remove/{id:[\\d]+}", "/plants/heart/{id:[\\d]+}", "/users/remove", "/users/refresh", "/diary/add", "/diary/remove/{id:[\\d]+}", "/diary/edit/{id:[\\d]+}").authenticated()
